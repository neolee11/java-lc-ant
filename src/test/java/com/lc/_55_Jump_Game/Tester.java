...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        ...
        int[] case2 = new int[] {3,2,1,0,4};
        boolean result2 = false;

        return Arrays.asList(new Object[][]{
             {case1, result1},     // test case 1 (init parameters below: {para1, para2, expected})
             {case2, result2},     // test case 2 (init parameters below: {para1, para2, expected})
    ...
    public void test() {
         ...
         boolean actual = solution.canJump(para1);
