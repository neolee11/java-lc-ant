...
public class Tester {
    ...
    public static Collection<Object[]> testcases() {
        ...
        return Arrays.asList(new Object[][]{
                {case1, resCase1},     // test case 1 (init parameters below: {para1, para2, expected})
                {case2, resCase2},     // test case 2 (init parameters below: {para1, para2, expected})
                {case3, resCase3}      // test case 3 (init parameters below: {para1, para2, expected})
        });
    }
